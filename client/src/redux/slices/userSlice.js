  ...
  async ({ page = 1, limit = 5 }, thunkAPI) => {
    try {
      const response = await axios.get(
        `https://booklovers-v1.onrender/api/users?page=${page}&limit=${limit}`
      );
      return {
  ...
  async (credentials, thunkAPI) => {
    try {
      const response = await axios.post(
        "https://booklovers-v1.onrender/api/user/loginadmin",
        credentials
      );
...
export const loginUser = createAsyncThunk(
  ...
  async (credentials, thunkAPI) => {
    try {
      const response = await axios.post(
        "https://booklovers-v1.onrender/api/user/loginuser",
        credentials
      );
      return response.data;
    } catch (error) {
...
export const createNewUser = createAsyncThunk(
  ...
  async (formData, thunkAPI) => {
    try {
      const response = await axios.post(
        "https://booklovers-v1.onrender/api/user",
        formData,
        {
...
export const getUserWithAddress = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      ...
      const response = await axios.get(
        "https://booklovers-v1.onrender/api/user/profile",
        {
          headers: {
...
export const createUserAddress = createAsyncThunk(
  ...
  async (addressData, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.post(
        "https://booklovers-v1.onrender/api/user/address",
        addressData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  async (addressData, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.put(
        "https://booklovers-v1.onrender/api/user/address/up",
        addressData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
...
export const setDefaultAddress = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.put(
        "https://booklovers-v1.onrender/api/user/address/set-default",
        { id },
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  async (id, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.delete(
        `https://booklovers-v1.onrender/api/user/address/${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  async (newPassword, { rejectWithValue, getState }) => {
    try {
      ...
      const res = await axios.put(
        "https://booklovers-v1.onrender/api/user/update-password",
        { newPassword },
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  async (token, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        "https://booklovers-v1.onrender/api/user/google-login",
        {
          token,
        }
      );
...
export const facebookLogin = createAsyncThunk(
  ...
  async (facebookAccessToken, { rejectWithValue }) => {
    try {
      const res = await axios.post(
        "https://booklovers-v1.onrender/api/user/facebook-login",
        {
